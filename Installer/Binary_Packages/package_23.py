...
logger = logging.getLogger("Package_23")
...
class Package_23:
    ...
    def __init__(self, gp):
        ...
        logger.debug("Packet 23: SCIT Past Position Data")
        ...
        while (actual_position < p_end_offset):
            ...
            if (p_packet_code == 6): # TODO also posible 2 or 25
                if gp.pdb.MH_msg_code == 141:
                    Package_6(gp,gp.mesocyclone.set_line_past)
                    
                if gp.pdb.MH_msg_code == 58:
                    Package_6(gp,gp.storm.set_line_past)
            else:
