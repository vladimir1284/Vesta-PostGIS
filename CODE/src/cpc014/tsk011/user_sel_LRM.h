...
*  RCS info
*  $Author: jeffs $
*  $Date: 2015/01/14 20:50:10 $
*  $Locker:  $
*  $Id: user_sel_LRM.h,v 1.5 2015/01/14 20:50:10 jeffs Exp $
*  $Revision: 1.5 $
*  $State: Exp $
*  $Log: user_sel_LRM.h,v $
*  Revision 1.5  2015/01/14 20:50:10  jeffs
*  Fix numerous compiler warnings
*
*  Revision 1.4  2004-02-10 16:09:37-06  ccalvert
*  code cleanup
*
